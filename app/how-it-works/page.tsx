                    ...
                    >
                        ...
                        <div className="relative mb-3 sm:mb-4">
                          <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center transition-all duration-500 ${
                            isActive 
                              ? 'bg-[#FF5722] text-white scale-110 shadow-lg'
                              : isCompleted
                              ? 'bg-[#FF5722]/60 text-white'
                              : 'bg-[#FFF8F0] text-[#4B5563] border-2 border-[#FF5722]/20'
                          }`}>
                          ...
                          {isActive && (
                            <div className="absolute -top-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-[#FF5722] rounded-full animate-pulse"></div>
                          )}
                        </div>

                        <h3 className={`text-base sm:text-lg md:text-xl font-bold mb-2 transition-colors duration-300 ${
                          isActive ? 'text-[#374151]' : isCompleted ? 'text-[#374151]/80' : 'text-[#374151]/70'
                        }`}>
                          {step.title}
                        </h3>
                        ...
                        <div className="absolute bottom-0 left-0 right-0 h-0.5">
                          ...
                          <div className={`absolute bottom-0 left-0 right-0 h-0.5 ${
                            isCompleted ? 'bg-[#FF5722]/60' : 'bg-[#FF5722]/10'
                          }`}></div>
                          {/* Animated progress border */}
                          {isActive && (
                            <div 
                              className="absolute bottom-0 left-0 h-0.5 bg-[#FF5722] transition-all duration-100 ease-linear"
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-6 sm:mb-8 lg:mb-12" data-scroll>
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#374151] mb-2">
          ...
          <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-5" data-scroll>
            ...
            <Card className="group overflow-hidden bg-white shadow-lg sm:col-span-5 lg:col-span-3 rounded-xl border-2 border-[#374151]/20 hover:border-[#374151]/40 hover:shadow-xl transition-all flex flex-col">
              <CardHeader className="p-4 sm:p-5 md:p-6 pb-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#FF5722] rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4">
                  <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                </div>
                <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-[#374151] mb-2">
                ...
                <p className="text-sm sm:text-base md:text-lg font-semibold text-[#FF5722]">
              ...
              <div className="relative h-fit pl-4 sm:pl-5 md:pl-6 pb-4 sm:pb-5 md:pb-6 mt-auto">
                ...
                <div className="bg-gradient-to-br from-[#FFF8F0] to-[#FF5722]/10 overflow-hidden rounded-lg border-2 border-[#FF5722]/20 p-1 sm:p-1.5">
                  <Image
                    src="/sec-5.png"
            ...
            <Card className="group overflow-hidden bg-white shadow-lg sm:col-span-5 lg:col-span-2 rounded-xl border-2 border-[#374151]/20 hover:border-[#374151]/40 hover:shadow-xl transition-all flex flex-col">
              <div className="p-4 sm:p-5 md:p-6 flex flex-col h-full">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#FF5722] rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4">
                  <Lock className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                </div>
                <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-[#374151] mb-2">
                ...
                <div className="mt-auto">
                  <div className="relative">
                    ...
                    <div className="aspect-video overflow-hidden rounded-lg border-2 border-[#FF5722]/20 bg-[#FFF8F0] relative max-h-20 sm:max-h-24">
                      <Globe className="w-8 h-8 sm:w-10 sm:h-10 text-[#FF5722] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Card 3 - Fees (Small) */}
            <Card className="group p-4 sm:p-5 md:p-6 bg-white shadow-lg sm:col-span-5 lg:col-span-2 rounded-xl border-2 border-[#374151]/20 hover:border-[#374151]/40 hover:shadow-xl transition-all flex flex-col">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#FF5722] rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4">
                <DollarSign className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
              </div>
              <h3 className="text-sm sm:text-base md:text-lg font-bold text-[#374151] mb-3">
                Simple, upfront fees
              </h3>
              <div className="space-y-2 sm:space-y-2.5 flex-grow">
                <div className="flex items-start gap-2">
                  <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-lg bg-[#FF5722]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
            ...
            <Card className="group relative bg-white shadow-lg sm:col-span-5 lg:col-span-3 rounded-xl border-2 border-[#374151]/20 hover:border-[#374151]/40 hover:shadow-xl transition-all flex flex-col">
              <div className="p-4 sm:p-5 md:p-6 flex flex-col h-full">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#FF5722] rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4">
                  <BarChart3 className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                </div>
                <h3 className="text-sm sm:text-base md:text-lg font-bold text-[#374151] mb-2">
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-32">
        <div className="max-w-7xl mx-auto">
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl" data-scroll>
            ...
            <div className="absolute top-1/2 left-1/2 w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 bg-[#FF5722]/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16 lg:p-20 text-center">
              <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
                ...
                <div className="pt-2 sm:pt-4">
                  <button 
                    onClick={openModal}
                    className="bg-[#FF5722] text-white px-8 sm:px-10 md:px-12 py-3 sm:py-4 md:py-5 rounded-xl font-bold text-base sm:text-lg md:text-xl tracking-wide uppercase hover:bg-[#E64A19] transition-all transform hover:scale-105 shadow-2xl relative overflow-hidden group w-full sm:w-auto"
                  >
                    <span className="relative z-10">Join the Waitlist</span>
                    <div className="absolute inset-0 bg-gradient-to-r from-[#E64A19] to-[#FF5722] opacity-0 group-hover:opacity-100 transition-opacity"></div>
                  </button>
                </div>
              </div>
            </div>
